...
```{r Unaligned_spectral_plots, dpi=150, fig.width=6, fig.height=5, out.width = figwidth.out}
drawSpec(X);
```
...
```{r Spectral_alignment_optimal_maxShift,fig.align='center', dpi=150, fig.width=6, fig.height=5, out.width = figwidth.out}
Y <- dohCluster(X,
                peakList = peakList,
                refInd = refInd,
                maxShift  = NULL,
...
```{r AlignedSpectral_plots, dpi=150, fig.width=6, fig.height=5, out.width = figwidth.out}
drawSpec(Y);
```
...
```{r AlignedSpectral_plots_limited_height, dpi=150, fig.width=6, fig.height=5, out.width = figwidth.out}
drawSpec(Y,
        startP=450,
        endP=680,
        highBound = 5e+5,
...
```{r Aligned_spectral_plots_customized, dpi=150, fig.width=6, fig.height=5, out.width = figwidth.out}
drawSpec(Yc);
```
...
```{r drawBW_1, dpi=150, fig.width=7, fig.height=7, out.width = figwidth.out}

drawBW(BW, perc,Y, groupLabel = groupLabel)

```

```{r drawBW_2, dpi=150, fig.width=7, fig.height=7, out.width = figwidth.out}
