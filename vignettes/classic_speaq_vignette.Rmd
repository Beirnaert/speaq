...
```{r Spectral_alignment_optimal_maxShift,fig.align='center'}
Y <- dohCluster(X,
                peakList = peakList,
                refInd = refInd,
                maxShift  = NULL,
...
```{r AlignedSpectral_plots_limited_height}
drawSpec(Y,
        startP=450,
        endP=680,
        highBound = 5e+5,
...
```{r Aligned_spectral_plots_customized}
drawSpec(Yc);
```
...
```{r drawBW_1, dpi=200, fig.width=7, fig.height=4, out.width = figwidth.out}

drawBW(BW, perc,Y, groupLabel = groupLabel)

```

```{r drawBW_2, dpi=200, fig.width=7, fig.height=4, out.width = figwidth.out}
