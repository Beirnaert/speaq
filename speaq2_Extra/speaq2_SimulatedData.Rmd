...
Now we have the labels which indicate the interesting peaks from the non interesting peaks. We obtained these with a nearest neighbour serach between the ppm values of speaq peaks and the ppm values of the ground truth peaks.
