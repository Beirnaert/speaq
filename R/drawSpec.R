#' Spectral plot
#'
#' This function allows to draw a segment or the whole spectra with limited high/low bounds of inten- sity.
#' 
...
#' @param useLog The default value is -1, that means do not use a logarit transformation. If users want to transform the intensities to logarit values before ploting, set it to 1.
